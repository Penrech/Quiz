...
public class QuizActivity extends AppCompatActivity {
    ...
    private void nextQuestion() {
        ...
        //si estic a la última pregunta,donar el resultats;
        if( curr == questions.length -1){
            giveResults();
        }else {
            curr++;
            // si veiem que és la ultima: camviar text del botó.
            if (curr == questions.length - 1) {
    ...
    private void loadQuestions() {
        ...
        responses = new int[answ.length];// en principi esta ple de 0
    }
